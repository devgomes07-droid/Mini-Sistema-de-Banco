...
public class Conta {
    ...
    // Contadores (para evolução futura)
    ...
    public boolean transferir(Conta destino, double valor) {
        ...
        destino.saldo += valor;
        historico.add(
                "Transferência enviada: R$ " + valor + " para " + destino.getNomeCompleto()
        );
        destino.historico.add(
                "Transferência recebida: R$ " + valor + " de " + getNomeCompleto()
        );
        return true;
    }
    ...
    // Métodos auxiliares (para evolução futura)
    public double getSaqueHoje() {
        return saqueHoje;
    }
    public double getTransferenciaHoje() {
        return transferenciaHoje;
    }
}